...
const About = () => {
  return (
    ...
    //           <span className='mb-4 block text-lg font-semibold text-blue'>
    //             Why Choose Us
    //           </span>
    ...
    //             className='inline-flex items-center justify-center rounded-md border border-transparent bg-blue px-7 py-3 text-center text-base font-medium text-white hover:bg-opacity-90'
    //           >
    //             Get Started
    //           </a>
    //         </div>
